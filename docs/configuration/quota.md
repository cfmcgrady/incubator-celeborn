...
| celeborn.quota.app.diskBytesWritten | 9223372036854775807b | Cluster level quota dynamic configuration for written disk bytes. | 0.4.1 |  | 
| celeborn.quota.app.diskFileCount | 9223372036854775807 | Cluster level quota dynamic configuration for written disk file count. | 0.4.1 |  | 
| celeborn.quota.app.enabled | false | Whether to enable app-level quota. When true, celeborn.quota.manager should set to `org.apache.celeborn.common.quota.AppQuotaManager`. | 0.4.1 |  | 
| celeborn.quota.app.hdfsBytesWritten | 9223372036854775807b | Cluster level quota dynamic configuration for written hdfs bytes. | 0.4.1 |  | 
| celeborn.quota.app.hdfsFileCount | 9223372036854775807 | Cluster level quota dynamic configuration for written hdfs file count. | 0.4.1 |  | 
...
| celeborn.quota.manager | org.apache.celeborn.common.quota.AppQuotaManager | QuotaManger class name. Default class is `org.apache.celeborn.common.quota.AppQuotaManager`. | 0.2.0 |  | 
<!--end-include-->
