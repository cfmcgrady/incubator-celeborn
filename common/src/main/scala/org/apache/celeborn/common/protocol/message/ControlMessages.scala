...
object ControlMessages extends Logging {
  ...
  object RegisterWorker {
    def apply(
        ...
        requestId: String,
        version: String): PbRegisterWorker = {
